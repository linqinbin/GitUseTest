...
//  TestProject
//
//  Created by linqinbin on 16/3/22.
...
{
    AutolayoutCellViewController* secondVC =
        [[AutolayoutCellViewController alloc] init];
...
- (void)NSInvocationTest
{
    ...
    //    NSMethodSignature有两个常用的只读属性a.
    //    numberOfArguments:方法参数的个数b.
